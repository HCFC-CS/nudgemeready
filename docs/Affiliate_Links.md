...
Commercial outbound links in Nudge Me Ready (gifts, cards, stays, parking, lounges, meet & greet, Ready4 pack supplies and similar) go through `src/services/affiliateLinks.ts`.
...
| Partner | Used for |
|---------|----------|
| Amazon | Gift / card shopping · Ready4 pack supplies |
| Moonpig | Cards · wedding |
| Notonthehighstreet | Gifts / cards · sensory · wedding · new baby |
| Argos | ADHD / Ready4 pack supplies |
