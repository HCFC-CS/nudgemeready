...
| Field | Value |
| --- | --- |
| **Pack id** | `ready4-appointments` |
| **Kind** | content |
| **Category** | lifestyle |
| **Version** | 1.0.0 |
| **Icon** | `calendar-outline` |
| **Source** | `src/data/readyPacks/ready4/appointments.ts` |
...
- Clinics
- Interviews
- Any fixed-time visit

---

## 2. Commercial / access

**Paid catalogue SKU:** `ready.pack.ready4_appointments`
...
- **Template id:** `prep-checklist`
- **Type:** `list`
- **Due in:** 5 day(s) from install
- **Notes:** Documents, forms and questions.
- **Checklist:**
  - Confirm time and place
  - Referral / letters / ID if needed
  - Questions written down
  - Anything to take packed

### Travel to appointment

- **Template id:** `travel-planner`
- **Type:** `list`
- **Due in:** 2 day(s) from install
- **Checklist:**
  - Route chosen
  - Parking / ticket sorted
  - Leave time set
  - Buffer for delays

### Leave for appointment

- **Template id:** `leave-reminder`
- **Type:** `reminder`
- **Priority:** needs_attention
- **Due in:** 0 day(s) from install
- **Notes:** Set your own leave time based on travel.
- **Speaking text:** Time to leave for your appointment when you are ready.
...
- **Checklist:**
  - Book next appointment if needed
  - Collect prescription / forms
  - Tell someone the outcome (optional)
  - Add notes below

### Appointment notes & outcomes

- **Template id:** `outcomes-note`
- **Type:** `note`
