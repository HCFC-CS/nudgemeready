...
- TestFlight tester sheet: `TESTFLIGHT_TESTER_INSTRUCTIONS.md`
- Live Ready 4 source: `src/data/readyPacks/ready4/`

## Honesty labels used in these docs

- **Shipped** — available in the current app build
- **Gated / stub** — data or UI present but feature flag / billing / coach UI off
- **Edition 1 commercial** — positioned in the published catalogue; may not all be live yet (e.g. Premium, bundles, white-label)
